...
CORE_SENSORS: tuple[VibeSensorDescription, ...] = (
    ...
    VibeSensorDescription(
        key="max_devices_ever",
        name="Max Devices Ever Seen",
        icon="mdi:devices-alert",
        state_class=SensorStateClass.MEASUREMENT,
        data_section="core",
        data_key="max_devices_ever",
    ),
    VibeSensorDescription(
        key="instance_age_days",
        name="HA Instance Age (Days)",
        icon="mdi:calendar-clock",
        native_unit_of_measurement=UnitOfTime.DAYS,
        state_class=SensorStateClass.MEASUREMENT,
        data_section="core",
        data_key="instance_age_days",
        extra_attrs={"first_seen_utc": "instance_first_seen_utc"},
    ),
    VibeSensorDescription(
        key="total_entities",
        name="Total Entities",
